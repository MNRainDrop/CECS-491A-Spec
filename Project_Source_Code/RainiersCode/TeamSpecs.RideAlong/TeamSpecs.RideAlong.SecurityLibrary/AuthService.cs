...
// claims based
// appAuthService.IsAuthorize(currentPrincipal, new Dictionary<string, string>() { Key: "RoleName", Value: "Admin" })

// role based
// appAuthService.IsAuthorize(currentPrincipal, "Admin")

public class UploadService
{
    private readonly AuthService _appAuthService;
    public UploadService(AuthService authService)
    {
        _appAuthService = authService;
    }
    public void Upload(..., requiredClaims)
    {
        var requiredClaims = new Dictionary<KeyValuePair>()
        {
